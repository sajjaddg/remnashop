...
inline-invite =
    ...
    .description = Click to send an invite link!
    .message =
        🚀 Hello! Want a stable and fast VPN?
        
        { $bot_name } — will help you with that!

        ↘️ PRESS THE BUTTON AND TRY FOR FREE!
    .start = 🚀 Join
...
frg-promocode-reward = { $promocode_type ->
    ...
    [PERSONAL_DISCOUNT] { $reward }% to personal discount
    [PURCHASE_DISCOUNT] { $reward }% to next purchase discount
    *[OTHER] { $reward }
    }
...
access-mode = { $access_mode ->
    ...
    [RESTRICTED] 🔴 Restricted for everyone
    *[OTHER] { $access_mode }
}
...
notification-type = { $notification_type ->
    ...
    [REFERRAL_REWARD_FAILED] Referral reward failed
    ...
    [BLACKLIST_ATTEMPT] User registration (blacklisted)
